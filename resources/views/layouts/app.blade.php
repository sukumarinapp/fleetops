...
<head>
        ...
        <div class="wrapper">
          ...
          @endif
               ...
               request()->segment(1) == 'telematicslog' ||           request()->segment(1) == 'workflow') ? 'active' : '' }}">
                ...
                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                  ...
                  <li><a href="{{ url('allvehicle') }}/1" class="dropdown-item {{ (request()->segment(1) == 'allvehicle' || request()->segment(1) == 'vehicle' || request()->segment(1) == 'assignvehicle' || request()->segment(1) == 'removevehicle') ? 'active' : '' }}" class="dropdown-item">Fleet Manager</a></li>
                  @endif
         ...
         <li class="dropdown dropdown-hover {{ ( request()->segment(1) == 'rhreport' || request()->segment(1) == 'sales' || request()->segment(1) == 'collection'  ) ? 'active' : '' }}">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="{{ url('sales') }}/{{ date('Y-m-d', strtotime('-6 days')) }}/{{ date('Y-m-d') }}" class="dropdown-item {{ (request()->segment(1) =='sales') ? 'active' : '' }}" class="dropdown-item">Sales Invoices (RT/HP)</a></li>
  ...
  <li class="dropdown dropdown-hover {{ (request()->segment(1) == 'workflowlog' || request()->segment(1) == 'vehiclelog' || request()->segment(1) == 'notificationslog' || request()->segment(1) == 'alertlog') ? 'active' : '' }}">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="{{ url('vehiclelog') }}/{{ date('Y-m-d', strtotime('-6 days')) }}/{{ date('Y-m-d') }}/2" class="dropdown-item {{ (request()->segment(1) == 'vehiclelog') ? 'active' : '' }}" class="dropdown-item">Vehicle Collection Log</a></li>

              <li><a href="{{ url('notificationslog') }}/{{ date('Y-m-d', strtotime('-6 days')) }}/{{ date('Y-m-d') }}/2" class="dropdown-item {{ (request()->segment(1) == 'notificationslog') ? 'active' : '' }}" class="dropdown-item">Notifications Log</a></li>
